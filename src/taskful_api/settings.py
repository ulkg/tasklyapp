...
SECRET_KEY = 'django-insecure-$$*ub6x#^)=2f=ce6lq)&p)wjjkp&$-uhnw9&7v6i39f667b13'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # see https://github.com/RealmTeam/django-rest-framework-social-oauth2
        'oauth2_provider.contrib.rest_framework.OAuth2Authentication',
        'rest_framework_social_oauth2.authentication.SocialAuthentication'
    ]
}

# backends that token based authentication can use
